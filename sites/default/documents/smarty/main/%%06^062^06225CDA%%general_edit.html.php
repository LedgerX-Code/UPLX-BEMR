<?php /* Smarty version 2.6.31, created on 2020-03-17 08:38:15
         compiled from C:/xampp/htdocs/openemr/templates/insurance_numbers/general_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'text', 'C:/xampp/htdocs/openemr/templates/insurance_numbers/general_edit.html', 11, false),array('modifier', 'attr', 'C:/xampp/htdocs/openemr/templates/insurance_numbers/general_edit.html', 16, false),array('modifier', 'attr_url', 'C:/xampp/htdocs/openemr/templates/insurance_numbers/general_edit.html', 33, false),array('function', 'xlt', 'C:/xampp/htdocs/openemr/templates/insurance_numbers/general_edit.html', 25, false),array('function', 'html_options', 'C:/xampp/htdocs/openemr/templates/insurance_numbers/general_edit.html', 68, false),)), $this); ?>
...
&showform=true"
                ...
                <span><?php echo smarty_function_xlt(array('t' => 'Add New'), $this);?>
        ...
        <?php if ($this->_tpl_vars['show_edit_gui']): ?>
            ...
            <div class="form-group">
                <label for="insurance_company_id" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Insurance Company'), $this);?>
</label>
                <div class="col-sm-8">
                    <?php if ($this->_tpl_vars['ins']->get_id() == ""): ?>
            ...
            <div class="form-group">
                <label for="provider_number" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Provider Number'), $this);?>
</label>
                <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
            ...
            <div class="form-group">
                <label for="provider_number_type" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Provider Number (Type)'), $this);?>
</label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <label for="rendering_provider_number" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Rendering Provider Number'), $this);?>
</label>
                <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
            ...
            <div class="form-group">
                <label for="rendering_provider_number_type" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Rendering Provider Number (Type)'), $this);?>
</label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <label for="group_number" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Group Number'), $this);?>
</label>
                <div class="col-sm-8">
