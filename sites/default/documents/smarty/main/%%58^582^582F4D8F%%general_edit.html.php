...
" class='form-horizontal' onsubmit="return top.restoreSession()">
    <div class="form-group">
        <label for="name" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Partner Name'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="id_number" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'ID Number (ETIN)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_isa01" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'User logon Required Indicator (ISA01~ use 00 or 03)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_isa02" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'User Logon (If 03 above, else leave spaces) (ISA02)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_isa03" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'User password required Indicator (ISA03~ use 00 or 01)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_isa04" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'User Password (ISA04~ if 01 above, else leave spaces)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_isa05" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Sender ID Qualifier (ISA05)'), $this);?>
</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="x12_sender_id" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Sender ID (ISA06)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_isa07" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Receiver ID Qualifier (ISA07)'), $this);?>
</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="x12_receiver_id" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Receiver ID (ISA08)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_isa14" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Acknowledgment Requested (ISA14)'), $this);?>
</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="x12_isa15" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Usage Indicator (ISA15)'), $this);?>
</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="x12_gs02" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Application Sender Code (GS02)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_dtp03" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Eligibility Service Date (270 DTP03)'), $this);?>
</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="12_per06" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Submitter EDI Access Number (PER06)'), $this);?>
</label>
        <div class="col-sm-8">
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-group">
        <label for="x12_version" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Version'), $this);?>
</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="processing_format" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Processing format'), $this);?>
</label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label for="x12_gs03" class="control-label col-sm-2"><?php echo smarty_function_xlt(array('t' => 'Application Receiver Code (GS03 - If blank ISA08 will be used)'), $this);?>
</label>
        <div class="col-sm-8">
