                ...
                <div class="col-sm-12">
                    <div>
                        <div class="center-block" style="max-width:400px">
                            <img class="img-fluid img-responsive center-block" src="<?php echo $GLOBALS['images_static_relative']; ?>/uplxlogo2.png" />
                        </div>
						<div class="col-sm-12 text-center">
                            <h4>
                                <?php echo xlt("Blockchain Electronic Medical Record System"); ?>
                            </h4>
                        </div>
...
<!--                    </p>-->
                    <h4>
                        <a href="../../acknowledge_license_cert.html" target="main"><?php echo xlt('Powered by OpenEMR'); ?></a>
                        <!--                        --><?php //echo xlt("Powered by OpenEMR"); ?>
                    </h4>
                </div>
